      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-slate-900/90 p-1 rounded-xl border border-slate-200 dark:border-slate-800 self-start sm:self-auto">
                  <button
                    ...
                    className={cn(
                      ...
                      timeRange === '7d' ? 'bg-[#0066FF] text-white shadow-xs' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200'
                    )}
                  >
                    7 Days
                  </button>
                  <button
                    ...
                    className={cn(
                      'px-3 py-1 rounded-lg text-xs font-bold transition-colors cursor-pointer',
                      timeRange === '30d' ? 'bg-[#0066FF] text-white shadow-xs' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200'
                    )}
                  >
                    30 Days
                  </button>
        ...
        {activeTab === 'orders' && (
          <div className="space-y-6 animate-in fade-in duration-200">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">Fulfillment & Orders Radar</h2>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      orderFilter === status
                        ...
                        : 'bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white border border-slate-200 dark:border-slate-700 shadow-2xs'
                    )}
                  >
                          ...
                          <td className="p-4 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              ...
                              <select
                                ...
                                className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-[11px] p-1 focus:outline-hidden"
                              >
        ...
        {activeTab === 'products' && (
          <div className="space-y-6 animate-in fade-in duration-200">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">Product Catalog & Inventory</h2>
                <p className="text-xs text-slate-500 dark:text-slate-400">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 p-4 rounded-xl bg-white dark:bg-[#0F172A] border border-slate-200/80 dark:border-slate-800 shadow-xs dark:shadow-md">
              <div className="relative flex-1 w-full">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl pl-9 pr-4 py-1.5 text-xs text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-hidden focus:border-[#0066FF]"
                />
              </div>
                    ...
                    {filteredProducts.map((prod) => {
                      ...
                      return (
                        <tr key={prod.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors">
                          ...
                          <td className="p-4">
                            <span className="text-[10px] font-bold uppercase px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300">
                          ...
                          <td className="p-4">
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                className="w-6 h-6 rounded-md bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-white font-bold flex items-center justify-center border border-slate-200 dark:border-slate-700 transition-colors"
                              >
                                -
                              </button>
                              <span
                                className={cn(
                                  ...
                                  totalStock <= 3 ? 'text-rose-500 dark:text-rose-400' : 'text-slate-800 dark:text-slate-200'
                                )}
                              >
                                {totalStock}
                              </span>
                              ...
                              {totalStock <= 3 && (
                                <span className="text-[10px] text-rose-500 dark:text-rose-400 font-bold uppercase">Low</span>
                              )}
                            </div>
                          </td>
                          <td className="p-4 text-right">
        ...
        {activeTab === 'luckydraw' && (
          <div className="space-y-6 animate-in fade-in duration-200">
            <div>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white">Lucky Draw Campaign & Simulator</h2>
              <p className="text-xs text-slate-500 dark:text-slate-400">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-gradient-to-br dark:from-[#0F172A] dark:to-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm dark:shadow-xl space-y-4">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">Select Draw Pool Tier:</label>
                  <select
                ...
                {lastDrawnWinner && (
                  <div className="p-3 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/30 text-amber-900 dark:text-amber-200 text-xs space-y-1 animate-in zoom-in-95">
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-[#0F172A] border border-slate-200/80 dark:border-slate-800 shadow-sm dark:shadow-xl space-y-4">
                ...
                <div className="space-y-3 pt-2 text-xs">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                    ...
                    <span className="font-mono font-bold text-slate-900 dark:text-white">Dec 31, 2026</span>
                  </div>
                  <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                    <span className="text-slate-500 dark:text-slate-400">Wheel Free Spins Given:</span>
                    <span className="font-mono font-bold text-emerald-600 dark:text-emerald-400">1,280 Daily Spins</span>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs text-slate-500">
                    ...
                    <button
                      ...
                      className="text-rose-500 hover:text-rose-600 dark:text-rose-400 dark:hover:text-rose-300 transition-colors p-1"
                      title="Delete code"
                    >
                      <Trash2 className="w-3.5 h-3.5" />
                    </button>
        ...
        {activeTab === 'customers' && (
          <div className="space-y-6 animate-in fade-in duration-200">
            <div>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white">Customers & JudesCoins Ledger</h2>
              <p className="text-xs text-slate-500 dark:text-slate-400">
            ...
            {/* Customer Card */}
            <div className="p-6 rounded-2xl bg-white dark:bg-[#0F172A] border border-slate-200/80 dark:border-slate-800 shadow-sm dark:shadow-xl space-y-5">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-amber-50 hover:bg-amber-100 dark:bg-amber-500/20 dark:hover:bg-amber-500/30 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-400/40 font-bold text-xs transition-all cursor-pointer"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-slate-100 dark:border-slate-800 text-xs">
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                  <span className="text-slate-500 dark:text-slate-400">Current Coins Balance</span>
                  <div className="flex items-baseline gap-2 mt-1">
                    <span className="text-2xl font-black text-amber-500 dark:text-amber-400 font-mono">
                      {judesCoins.toLocaleString()}
                    </span>
                    <span className="text-slate-500 dark:text-slate-400">Coins</span>
                  </div>
                </div>

                <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                  <span className="text-slate-500 dark:text-slate-400">Total Lifetime Orders</span>
                  <div className="flex items-baseline gap-2 mt-1">
                    <span className="text-2xl font-black text-slate-900 dark:text-white font-mono">{user.orders.length}</span>
                    <span className="text-slate-500 dark:text-slate-400">Completed</span>
                  </div>
                </div>

                <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                  <span className="text-slate-500 dark:text-slate-400">Default Shipping Address</span>
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl space-y-4">
            ...
            <form onSubmit={handleCreateProduct} className="space-y-4 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1">Draw Tier</label>
                  <select
              ...
              <div className="flex items-center gap-2 pt-2">
                ...
                />
                <label htmlFor="isJudesBrand" className="text-slate-700 dark:text-slate-300 font-medium">
      ...
      {isAddPromoOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/70 backdrop-blur-sm animate-in fade-in">
          <div className="relative w-full max-w-md bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Create Promo Code</h3>
              <button
            ...
            <form onSubmit={handleCreatePromo} className="space-y-4 text-xs">
              <div>
                <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1">Coupon Code (Uppercase)</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-slate-900 dark:text-white font-mono uppercase focus:outline-hidden focus:border-[#0066FF]"
                />
              </div>
