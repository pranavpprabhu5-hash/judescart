    ...
    >
      ...
      <div className="relative aspect-[3/4] w-full overflow-hidden bg-slate-100">
        ...
        <button
          ...
          className="absolute top-3 right-3 z-10 p-2 rounded-full bg-white/90 backdrop-blur-md shadow-xs border border-slate-200/80 text-slate-700 hover:text-rose-600 hover:bg-white transition-all active:scale-90"
      ...
      <div className="p-4 space-y-2 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="flex flex-wrap items-center gap-1 pt-1">
            ...
            {product.brand === 'JUDES' && (
              <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-extrabold bg-gradient-to-r from-amber-500/15 to-blue-500/15 text-[#0A192F] border border-amber-400/60">
                👑 JUDES Bumper
              </span>
            )}
          </div>
